...
SECRET_KEY = 'django-insecure-(n2_6c)87-(ik=_fpumtznw0umz(txqly5x@x+xx-ulc_4pn=h'
...
ROOT_URLCONF = 'land_management.urls'
...
WSGI_APPLICATION = 'land_management.wsgi.application'
